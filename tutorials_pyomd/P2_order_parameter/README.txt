...
This tutorial computes the P2 order parameter.
...
python (or python3) PE_100c_120ns_slab_P2_order_param_C_atoms_ref.py > PE_100c_120ns_slab_P2_order_param_C_atoms_ref.out

The file "PE_100c_120ns_slab_P2_order_param_C_atoms_ref.out" has the P2 order
parameter for each atomic index. A compressed xyz file is generated (".xyz.gz").
The dynamics of the P2 order parameter can be visualized using OVITO Basic.
...
#Nematic Atom      #P2 order parameter       #color
      X                 [0.9, 1.0]           #ffffff
      Y                 [0.8, 0.9[           #67988e
      Z                 [0.7, 0.8[           #33ffff
      A                 [0.6, 0.7[           #b300ff
