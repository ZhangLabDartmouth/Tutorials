...
output_filename = "all_atoms_ref_quench_single_frame_interchain.xyz.gz"
...
for chain in chains:
    ...
    backbones.append(chain.select_atoms('name C*'))
    ######################## change this parameters ############################
...
atoms_reference_list,atoms_index_list,box_unit_cell,num_cores=number_of_cores,interchain_=True,use_threshold_radius_=True,threshold_radius_=threshold_radius)
